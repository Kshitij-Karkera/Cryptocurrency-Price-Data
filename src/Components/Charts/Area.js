...
function Area({ theme, data, interval, symbol }) {
    ...
    useEffect(() => {
        ...
        renderChartElements(zoomableContainer, x, y, data, areaGenerator);
        ...
        const zoomBehavior = zoom()
            ...
            .on('zoom', (event) => {
                ...
                zoomableContainer.select('.area-path')
                    .attr("d", areaGenerator.x(d => newX(new Date(d[0]))));
    ...
    function renderChartElements(container, xScale, yScale, data, areaGenerator) {
